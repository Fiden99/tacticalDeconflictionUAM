...
do
    ...
    do
        ...
        absPath=$PWD datFile=$datFileBase alpha=$alpha gapUnf=$gap ampl /home/magi/UAMdeconflictionMasterThesis/modelli/UAM_heur_run/mercedesHeuristicSbatchDD.run

        absPath=$PWD datFile=$datFileBase alpha=$alpha gapUnf=$gap ampl /home/magi/UAMdeconflictionMasterThesis/modelli/UAM_heur_run/mercedesHeuristicDDGreater.run

        absPath=$PWD datFile=$datFileBase alpha=$alpha gapUnf=$gap ampl /home/magi/UAMdeconflictionMasterThesis/modelli/UAM_heur_run/mercedesHeuristicDDSmaller.run
    done
done
